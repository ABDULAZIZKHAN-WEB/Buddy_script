...
export default function CreatePost({ onPostCreated, user }) {
  ...
  return (
    <div className="_feed_inner_text_area _b_radious6 _padd_t24 _padd_b24 _mar_b16">
      <div className="_feed_inner_text_area_content _padd_r24 _padd_l24">
        <form onSubmit={handleSubmit}>
          <div className="_feed_inner_text_area_top">
            <div className="_feed_inner_text_area_top_image">
              <img src="/assets/images/profile.png" alt="Profile" />
            </div>
            <div className="_feed_inner_text_area_top_input">
              <textarea
          ...
          {imagePreview && (
            <div className="_image_preview _mar_t15 _mar_b15">
              <img src={imagePreview} alt="Preview" />
              <button
                type="button"
                className="btn btn-sm btn-danger _mar_t10"
                onClick={() => {
                  setImage(null);
                  setImagePreview(null);
                }}
          ...
          {error && (
            <div className="alert alert-danger _mar_t15" role="alert">
              {error}
            </div>
          )}
            ...
            <div className="_feed_inner_text_area_item">
              <div className="_feed_inner_text_area_bottom_photo _feed_common">
                <label style={{ margin: 0, cursor: 'pointer' }}>
                  <input
                    ...
                    style={{ display: "none" }}
                  />
                  <button type="button" className="_feed_inner_text_area_bottom_photo_link" onClick={(e) => { e.preventDefault(); e.target.previousElementSibling.click(); }}>
              ...
              <div className="_feed_inner_text_area_bottom_video _feed_common">
                <select
                  ...
                  style={{ border: 'none', background: 'transparent', fontSize: '14px', color: '#666', padding: '8px 12px' }}
                >
