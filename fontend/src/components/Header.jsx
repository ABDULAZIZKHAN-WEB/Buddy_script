          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div className="_header_nav_profile">
              ...
              <div className="_header_nav_dropdown">
                ...
                <button className="_header_nav_dropdown_btn _dropdown_toggle" type="button" data-bs-toggle="dropdown">
              ...
              <ul className="dropdown-menu _nav_profile_dropdown _profile_dropdown">
                ...
                <li className="_nav_dropdown_list_item">
                  <button onClick={handleLogout} className="_nav_dropdown_link dropdown-item" style={{ width: '100%', textAlign: 'left', border: 'none', background: 'none' }}>
                    <div className="_nav_drop_info">
                      <span>
